...
function order() {
    ...
    alert('Welcome to The Unnamed pub\n\nDue to the ongoing Covid-19 pandemic you can now temporarily order online!\n\nClick OK to see our menu')
    orderStatus = true;
    while (orderStatus === true) {
        ...
        switch (quest) {
            case 'stop':
                ...
                if (check.soda === true) {
                    document.getElementById('output').innerHTML += orders.soda + ' soda x ' + price.soda + ' = ' + total.soda + '<br>';
                }
                if (check.beer === true) {
                    document.getElementById('output').innerHTML += orders.beer + ' beer x ' + price.beer + ' = ' + total.beer + '<br>';
                }
                if (check.wine === true) {
                    document.getElementById('output').innerHTML += orders.wine + ' wine x ' + price.wine + ' = ' + total.wine + '<br>';
                }
                if (check.bowl8 === true) {
                    document.getElementById('output').innerHTML += orders.bowl8 + ' bowls of 8 x ' + price.bowl8 + ' = ' + total.bowl8 + '<br>';
                }
                if (check.bowl16 === true) {
                    document.getElementById('output').innerHTML += orders.bowl16 + ' bowls of 16 x ' + price.bowl16 + ' = ' + total.bowl16 + '<br>';
                }
                break;
            case 'soda':
